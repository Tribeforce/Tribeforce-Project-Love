...
*/
   ...
   */
    public function permissions() {
      return $this->morphMany('Right', 'permission');
    }

  /**
   * Set the relation with the goals
   * @return The relationship
   */
   ...
   * @return The relationship
   */
    public function feedbackables() {
      return $this->hasMany('Feedbackable');
    }
   ...
   * @return The relationship
   */
    public function belongCircles() {
      return $this->belongsToMany('Circle');
    }
  ...
  /**
   * Set the relation with the endorsements provided by this user TO others
   * @return The relationship
   */
